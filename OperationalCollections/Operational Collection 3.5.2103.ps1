...
# 2021/10/07 - Add Collection 101-108 - New Windows builds and SCCM client versions
#           
...
#Refresh Schedule
$Schedule = New-CMSchedule –RecurInterval Hours –RecurCount 6
...
$DummyObject |
Select-Object @{L="Name"
; E={"Clients Version | Not Latest (2103)"}},@{L="Query"
; E={"select SMS_R_SYSTEM.ResourceID,SMS_R_SYSTEM.ResourceType,SMS_R_SYSTEM.Name,SMS_R_SYSTEM.SMSUniqueIdentifier,SMS_R_SYSTEM.ResourceDomainORWorkgroup,SMS_R_SYSTEM.Client from SMS_R_System
 where SMS_R_System.ClientVersion not like '5.00.9049.10%'"}},@{L="LimitingCollection"
; E={"Clients | All"}},@{L="Comment"
; E={"All devices without SCCM client version 2103"}}
